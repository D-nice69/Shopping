...
<div class="content-wrapper">
    @include('adminPatials.content_header',['name'=>'Slider','key' =>'Edit'])
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-6 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" @error('name') is-invalid @enderror
                                placeholder="Nhập tên sản phẩm" value="{{ $slider->name}}{{ old('name') }}">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12 image_container">
                                <div class="row">
                                    <img class="" src="{{ $slider->image_path }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {{ $slider->description }}{{ old('description') }}
                        </textarea>
                    </div>
                    @error('description')
                    <div class="alert alert-danger">{{ $message }}</div>
