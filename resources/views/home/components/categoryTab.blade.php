<div class="category-tab">
    ...
    <div class="tab-content">
        @foreach ($categories as $value => $categoryItem)
            <div class="tab-pane fade {{ $value == 0 ? 'active in' : '' }}" id="category_tab_{{ $categoryItem->id }}">
                @foreach ($categoryItem->products as $categoryProductitem)
                    <div class="col-sm-3">
